...
public class ListPackageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println("DEBUG - ListPackageActivity role: " + role);
        System.out.println("DEBUG - ListPackageActivity category: " + category);
        System.out.println("DEBUG - Role equals Admin: " + "Admin".equals(role));
        System.out.println("DEBUG - Role is null: " + (role == null));
