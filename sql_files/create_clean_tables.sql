-- Create Clean Package and Sub-Package Tables (without description, image_url, price)
-- This script creates the table structure only, no data insertion

PRINT '=== CREATING CLEAN PACKAGE AND SUB-PACKAGE TABLES ===';

-- Step 1: Create packages table (without description, image_url, price)
...
PRINT 'packages table created successfully (clean structure)';

-- Step 2: Create sub_packages table (without price)
...
PRINT 'sub_packages table created successfully (clean structure)';
...
PRINT '=== CLEAN TABLE CREATION COMPLETE ===';
